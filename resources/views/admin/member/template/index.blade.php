            ...
            <div class="col-md-12">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb pl-0">
                        ...
                        <li class="breadcrumb-item " aria-current="page"><a href="{{route('template.index')}}">Template</a></li>
                    </ol>
...
{{--                            </select>--}}
{{--                        </form>--}}
                        <a href="{{route('template.create')}}" class="ms-text-primary">Add Template </a>
                    </div>
                                ...
                                @if(!empty($alldata) &&  $alldata->count()>0)
                                    @foreach($alldata as $key=>$val)
                                        <tr role="row" class="odd">
                                            ...
                                            <td class="action">
                                                <a href="/template/{{ $val->edit_id }}/edit"><i class="fas fa-pencil-alt ms-text-primary"></i></a>
