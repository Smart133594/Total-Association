                        ...
                        <div class="ms-panel">
                            ...
                            <div class="ms-panel-body" style="height: 500px;">
                                    <div class="form-group">
                                        <label style="display: none;" for="exampleEmail">Template Name <span>*</span></label>
                                        <select class="form-control" id="templateName" name="templateName" style="display: none;" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        &nbsp; Property &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <input type="radio" name="to_mail" value="Group" onclick="getgroup(0)">&nbsp; Group
                                    </div>
                    ...
                    <div class="ms-panel-body">
                        @include('admin.includes.msg')
                            ...
                            <div class="form-group" align="left">
                                ...
                                <input type="button" class="btn btn-primary" value="Save As" />
                                <div class="col-2"></div>
                                <input type="submit" class="btn btn-primary d-block" value="Send">
                            </div>
                        </form>
                    </div>
                </div>
