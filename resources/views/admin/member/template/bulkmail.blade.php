                            ...
                            <div class="row">
                                <div class="col-md-10">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="radio" name="to_mail" value="Individual" onclick="getgroup(1)" checked>&nbsp; Individual &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="to_mail" value="Group" onclick="getgroup(0)">&nbsp; Group
                                    </div>
