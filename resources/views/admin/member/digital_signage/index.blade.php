            ...
            <div class="col-md-12">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb pl-0">
                        ...
                        <li class="breadcrumb-item " aria-current="page"><a href="{{route('digital-signage-group.index')}}">Digital Signage Group</a></li>
                    </ol>

                </nav>
                <div class="ms-panel">
                    <div class="ms-panel-header ms-panel-custome">
                        <h6>Digital Signage Group</h6>
                        <form action="" method="get" style="position: absolute;left: 240px;top: 20px">
                     ...
                     @if(Auth::user()->role==1)   <a href="{{route('digital-signage-group.create')}}" class="ms-text-primary">Add Group</a>@endif
                    </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped thead-primary w-100" id="data-table">
                                ...
                                <tr role="row">
                                    ...
                                    <th style="min-width: 500px !important; width: 320px;">Group Name</th>
                                ...
                                @if(!empty($alldata) &&  $alldata->count()>0)
                                    @foreach($alldata as $key=>$val)
                                        <tr role="row" class="odd">
                                            ...
                                            <td class="action">
                                                <a href="/digital-signage-group/{{ $val->edit_id }}/edit"><i class="fas fa-pencil-alt ms-text-primary"></i></a>
