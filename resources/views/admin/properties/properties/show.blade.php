                        ...
                        <div class="col-md-12">
                            <table class="table table-striped thead-primary w-100 dataTable no-footer">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Address</td>
                                        <td>{{ $property->address1 }}<br> {{ $property->address2 }}<br>
                                    ...
                                    <tr>
                                        <td>Status</td>
                                        <td>
                                            @if ($property->status == 1)<span
                                                style="color: #13ce18">Current</span> @else <span
                                                    style="color: #ff0000">Deliquent</span></i>@endif
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                                    ...
                                    <td class="action">
                                        ...
                                        <div class="dropdown show">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                <a class="dropdown-item" href="/owner/{{ $val->owner_id }}"> OwnerInfo </a>
                                    ...
                                    <td class="action">
                                        ...
                                        <div class="dropdown show">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                ...
                                                <a class="dropdown-item" href="/letter-generator?type=Residents&user={{ $val->edit_id }}"> Send Letter </a>
                                                <a class="dropdown-item" href="/bulk-communication?type=Residents&user={{ $val->edit_id }}"> Send Email </a>
                            ...
                            @foreach ($property->Guest as $val)
                                <tr>
                                    ...
                                    <td class="action">
                                        ...
                                        <div class="dropdown show">
                                            <a class="cust-btn dropdown-toggle" href="#" role="button" id="dropdownMenuLink"
                                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                <i class="fas fa-th"></i>
                                            </a>
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                <a class="dropdown-item" href="/owner/{{ $val->owner_id }}"> Owner Info
                                                </a>
