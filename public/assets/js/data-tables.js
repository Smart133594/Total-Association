...
var dataSet = [
    ...
    [ "<img src='assets/img/dashboard/patient-1.jpg'>  Julia Sims", "Walker Dr, Houma, LA, United States", "Celiac ", "27", "	(680) 432 2662", "juliasims@example.com", "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a> <a href='a'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
    ...
    [ "<img src='assets/img/dashboard/patient-2.jpg'>  Linda", "Victory Garden, Tallahassee", "Heart Attack", "24", "(218) 661 8316", "	lindacarpenter@example.com", "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a> <a href='a'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
    ...
    [ "<img src='assets/img/dashboard/patient-1.jpg'>  Michael",  "Linden Avenue, Orlando", "Celiac ", "24", "	(797) 506 1265", "michaelsilva@example.com", "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a> <a href='a'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
    ...
    [ "<img src='assets/img/dashboard/patient-2.jpg'>  Gloria ", "LA, United States", "Cold", "27", "	(680) 432 2662", "glorialittle@example.com", "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a> <a href='a'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
    ...
    [ "<img src='assets/img/dashboard/patient-1.jpg'>  Angelica",  "Linden Avenue, Orlando","Liver Disease",  "24", "	(797) 506 1265", "angelicaramos@example.com", "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a> <a href='a'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
    ...
    [ "<img src='assets/img/dashboard/patient-2.jpg'>  Jennifer ", "Milwaukee, WI","Autoimmune",  "35", "(192) 494 8073", "jenniferchang@example.com", "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a> <a href='a'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
    ...
    [ "<img src='assets/img/dashboard/patient-1.jpg'>  Gavin ", "Fairways Cir, Vero Beach", "Autoimmune", "	7", "	(981) 756 6128", "gavincortez@example.com", "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a> <a href='a'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
    ...
    [ "<img src='assets/img/dashboard/patient-2.jpg'>  Unity",  "New Haven, Columbia", "Celiac ", "22", "(634) 09 3833", "butler@example.com", "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a> <a href='a'><i class='far fa-trash-alt ms-text-danger'></i></a>" ]
  ];
  ...
  var dataSet1 = [
    ...
    var dataSet2 = [
      ...
      var dataSet3 = [
          ...
          [ "APT0004", "<img src='assets/img/dashboard/patient-2.jpg'>Judy", "23", "Yuri Berry", "Orthopedics", "19 Dec 2020", "10:00am-12:00am", "Diabeties", "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a>   <a href='#'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
          ...
          [ "APT0007", "<img src='assets/img/dashboard/patient-1.jpg'>Jennifer", "29", "Doris Wilder", "Gynaecology", "5 Dec 2020", "10:00am-12:00am","Diabeties", "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a>   <a href='#'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
          ...
          [ "APT000a2", "<img src='assets/img/dashboard/patient-2.jpg'>Jennifer", "29", "Doris Wilder", "Gynaecology", "5 Dec 2020", "10:00am-12:00am", "Asthma",   "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a>   <a href='#'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
          ...
          [ "APT000a6", "<img src='assets/img/dashboard/patient-1.jpg'>Jennifer", "29", "Doris Wilder", "Gynaecology", "5 Dec 2020", "10:00am-12:00am",  "Cold",  "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a>   <a href='#'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
